...
public class PickItem {
    ...
    public PickItem(String flowerShopImage, String portfolioImage, String title, String context, String price, String discount) {
    ...
    public PickItem(String flowerShopImage, String portfolioImage, String title, String context, String price) {
        this.flowerShopImage = flowerShopImage;
        this.portfolioImage = portfolioImage;
        this.title = title;
        this.context = context;
