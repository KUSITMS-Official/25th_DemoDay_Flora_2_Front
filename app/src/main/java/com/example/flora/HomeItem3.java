...
public class HomeItem3 {
    ...
    public HomeItem3(String flowerShopImage, String portfolioImage, String title, String context, String price, String discount) {
    ...
    public HomeItem3(String flowerShopImage, String portfolioImage, String title, String context, String price) {
        this.flowerShopImage = flowerShopImage;
        this.portfolioImage = portfolioImage;
        this.title = title;
        this.context = context;
