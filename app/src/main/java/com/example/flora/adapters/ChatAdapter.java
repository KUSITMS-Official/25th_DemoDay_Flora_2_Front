...
import com.example.flora.databinding.ItemContainerRecievedMessageBinding;
import com.example.flora.databinding.ItemContainerSentMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        if(chatMessages.get(position).senderId.equals("juyeon")) {
